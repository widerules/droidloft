...
namespace Transition {
    ...
    public:
        wyTransitionTestLayer():wyColorLayer(wyc4b(0, 0, 255, 255)) {
            ...
            wyMenuItemLabel* item1 = wyMenuItemLabel::make(NULL, (wyTargetSelector*)(new wyTargetSelector(this, 0, NULL))->autoRelease(), label1);
            wyMenuItemLabel* item2 = wyMenuItemLabel::make(NULL, (wyTargetSelector*)(new wyTargetSelector(this, 1, NULL))->autoRelease(), label2);
            wyMenuItemLabel* item3 = wyMenuItemLabel::make(NULL, (wyTargetSelector*)(new wyTargetSelector(this, 2, NULL))->autoRelease(), label3);
        ...
        wyTransitionTestLayer(bool replace) : wyColorLayer(wyc4b(replace ? 255 : 0, replace ? 0 : 255, 0, 255)) {
            ...
            wyMenuItemLabel* item1 = wyMenuItemLabel::make(NULL,
            		(wyTargetSelector*)(new wyTargetSelector(this, (replace ? 3 : 4), NULL))->autoRelease(), label1);
